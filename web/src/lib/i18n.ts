...
const zhToEn = {
    ...
    "用于图片和视频生成。建议在主站用 media 分组创建媒体 Key；异步图片和异步视频任务按 4 倍扣费。": "Used for image and video generation. Create the media key from the media group on RelayBases. Async image and async video tasks cost x4.",
    ...
    "生图推荐 media 分组": "Image Generation: media Group Recommended",
