...
const coreZhToEn = {
    ...
    "普通视频模型默认同步调用，也可切换异步·4 倍扣费；Grok 视频模型固定异步且不加收 4 倍费用。": "Regular video models use sync calls by default and can switch to async at x4 cost. Grok video models are fixed to async with no x4 surcharge.",
