...
export const canvasZhToEn = {
    ...
    "局部编辑": "Local Edit",
    "MJ 放大": "MJ Upscale",
    "Midjourney 放大（U）": "Midjourney upscale (U)",
    "MJ 变体": "MJ Variation",
    "Midjourney 变体（V）": "Midjourney variation (V)",
    "MJ 扩图": "MJ Zoom Out",
    "Midjourney 扩展画面（Zoom Out 2x）": "Midjourney zoom out (2x)",
    "MJ 重绘": "MJ Inpaint",
    "Midjourney 局部重绘（Vary Region）": "Midjourney inpaint (Vary Region)",
    "切图": "Split Image",
    "超分": "Upscale",
    "存素材": "Save To Assets",
    "下载": "Download",
